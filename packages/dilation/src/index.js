...
/**
 * Derive phase-specific key
 * @param {Uint8Array} key
 * @param {string} side
 * @param {string} phase
 * @returns {Promise<Uint8Array>}
 */
async function derivePhaseKey(key, side, phase) {
  ...
  return hkdf(sha256, key, new Uint8Array(0), purpose, 32);
}
...
/**
 * Dilation timeout in milliseconds - reduced from 30s for better UX
 */
const DILATION_TIMEOUT_MS = 10000;
